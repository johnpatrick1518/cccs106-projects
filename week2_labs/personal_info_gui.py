    ...
    def generate_profile(e):
        try:
            ...
            profile_content = ft.Column([
                ...
                ft.Divider(),
                ft.Text(f"👤 Full Name: {first_name.value} {last_name.value}", size=16, color=ft.Colors.BLACK87),
                ft.Text(f"🆔 Student ID: {student_id.value or 'Not provided'}", size=16, color=ft.Colors.BLACK87),
                ft.Text(f"🎂 Age: {age.value} years old", size=16, color=ft.Colors.BLACK87),
                ft.Text(f"📅 Birth Year: {birth_year}", size=16, color=ft.Colors.BLACK87),
                ft.Text(f"📚 Program: {program_dropdown.value or 'Not selected'}", size=16, color=ft.Colors.BLACK87),
                ft.Text(f"📊 Year Level: {year_level.value or 'Not selected'}", size=16, color=ft.Colors.BLACK87),
                ft.Text(f"🎨 Favorite Color: {favorite_color.value or 'Not selected'}", size=16, color=ft.Colors.BLACK87),
                ft.Text(f"🎯 Hobbies: {hobbies.value or 'Not provided'}", size=16, color=ft.Colors.BLACK87),
                ft.Divider(),
                ft.Text(f"🎓 Expected Graduation: {graduation_year}", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.BLACK87),
                ft.Text(f"📝 Profile generated on: {datetime.now().strftime('%B %d, %Y at %I:%M %p')}", size=12, color=ft.Colors.BLACK87),
            ])
